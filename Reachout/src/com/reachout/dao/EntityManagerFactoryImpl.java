...
//
//	// /**
//	// * Parameterize constructor to load configuration for no sql databases
//	// other than Cassandra.
//	// * @param persistenceUnitName
//	// * @param isCassandra
//	// */
//	// public EntityManagerFactoryImpl(String persistenceUnitName, boolean
//	// isCassandra){
...
//		onLoad(persistenceUnitName);
//		this.props = props;
//		// // if props is NULL or empty, look for kundera.properties and
//		// populate
...
//	// " not found on classpath. Could not initialize Kundera.");
//	// }
//	// props_.load(stream);
//	// props = props_;
//	// stream.close();
...
//	// } catch (Exception e) {
//	// throw new
//	// IllegalArgumentException("Mandatory property missing 'kundera.nodes'");
//	// }
//	//
//	// // kundera.port
...
//	// throw new
//	// IllegalArgumentException("Mandatory property missing 'kundera.port'");
//	// }
//	// try {
//	// port = Integer.parseInt(kunderaPort);
//	// } catch (Exception e) {
//	// throw new
//	// IllegalArgumentException("Invalid value for property 'kundera.port': " +
//	// kunderaPort + ". (Should it be 9160?)");
//	// }
//	//
//	// // kundera.keyspace
...
//	// throw new
//	// IllegalArgumentException("Mandatory property missing 'kundera.keyspace'");
//	// }
//	//
//	// // kundera.client
...
//	// throw new
//	// IllegalArgumentException("Mandatory property missing 'kundera.client'");
//	// }
//	//
//	//
...
//	// cassandraClient = cassandraClient.substring( 0, cassandraClient.length()
//	// - 6 );
//	// }
//	//
...
//	// } catch (Exception e) {
//	// throw new
//	// IllegalArgumentException("Invalid value for property 'kundera.client': "
//	// + cassandraClient +
//	// ". (Should it be com.impetus.kundera.client.PelopsClient?");
//	// }
//	//
//	// log.info("Connecting to Cassandra... (nodes:" + Arrays.asList(nodes) +
//	// ", port:" + port + ", keyspace:" + keyspace + ")");
//	//
...
//	// try {
//	// Class<CacheProvider> cacheProviderClass = (Class<CacheProvider>)
...
//	// }
//	// log.info("Initialized second-level cache. Provider: " +
